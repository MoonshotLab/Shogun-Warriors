...
exports.createScreenshot = function(tweetId){
  ...
  var url       = config.URL + '/tweet/' + tweetId;
  var filePath  = 'screenshots/' + tweetId + '.png';
  var stream    = fs.createWriteStream(filePath);

  stream.on('finish', function(){ deferred.resolve(filePath);});
